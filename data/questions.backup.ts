...
export const questions: Question[] = [
  ...
  },
  {
    ...
    questionTextFr: "À quelle wilaya historique Djelfa a-t-elle été rattachée pendant la révolution ?",
    answers: [
      { text: "الولاية الرابعة", textFr: "Wilaya IV", correct: false },
      { text: "الولاية السادسة", textFr: "Wilaya VI", correct: true },
      { text: "الولاية الأولى", textFr: "Wilaya I", correct: false },
      { text: "الولاية الخامسة", textFr: "Wilaya V", correct: false },
    ],
    difficulty: Difficulty.Easy,
  },
  {
    questionText: "بماذا اشتهرت خيام قبيلة أولاد نايل كعلامة للشرف؟",
    questionTextFr: "Par quoi étaient célèbres les tentes de la tribu Ouled Naïl comme signe d'honneur ?",
    answers: [
      { text: "لونها الأبيض الناصع", textFr: "Leur couleur blanche éclatante", correct: false },
      { text: "لونها الأحمر", textFr: "Leur couleur rouge", correct: true },
      { text: "حجمها الكبير", textFr: "Leur grande taille", correct: false },
      { text: "زخارفها الذهبية", textFr: "Leurs décorations dorées", correct: false },
    ],
    difficulty: Difficulty.Easy,
  },
  {
    questionText: "ما هي المهمة الأولى لزاوية سيدي محمد بن يعقوب حسب النص؟",
    questionTextFr: "Quelle est la mission principale de la zaouïa de Sidi Mohamed Ben Yacoub ?",
    answers: [
      { text: "التجارة", textFr: "Le commerce", correct: false },
      { text: "تعليم القرآن", textFr: "L'enseignement du Coran", correct: true },
      { text: "الزراعة", textFr: "L'agriculture", correct: false },
      { text: "التدريب العسكري", textFr: "L'entraînement militaire", correct: false },
    ],
    difficulty: Difficulty.Easy,
  },
  {
    questionText: "ما هو أصل سيدي نايل حسب النص؟",
    questionTextFr: "Quelle est l'origine de Sidi Naïl selon le texte ?",
    answers: [
      { text: "تركي", textFr: "Turc", correct: false },
      { text: "شريف إدريسي حسني", textFr: "Chérif idrisside hassani", correct: true },
      { text: "أمازيغي صنهاجي", textFr: "Amazigh sanhadji", correct: false },
      { text: "عربي هلالي", textFr: "Arabe hilalien", correct: false },
    ],
    difficulty: Difficulty.Easy,
  },
